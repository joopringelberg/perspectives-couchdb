...
addAttachment_ :: String -> String -> String -> MediaType -> Effect (Promise DeleteCouchdbDocument)
...
addAttachment :: EffectFn4 String String String MediaType (Promise DeleteCouchdbDocument)
